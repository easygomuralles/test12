...
<div class="im">
    <img class="imv"src="{{voyager::image(setting('site.por2'))}}">
    <img class="imv1"src="{{voyager::image(setting('site.icon1'))}}">
    <h1 class="tit1">RECOMPOSICION</h1>
     <p class="principal">si tu ordenador dejo de funcionar como debe y no sabes porque ,o tuvo un accidente puedes traerlo con plena confianza con nuestro equipo el cual te dara la solucion a tu problema</p>
     <p class="principal" >les ofrecemos servicio de reparacion .</p>
 ...
 <div class="otras">
    ...
    <div class="soluciones">
        <div class="desarrollo_web">
             ...
             <p>Conoce mas sobre el servicio que ofrecemos orientado a el desarrollo y diseño de paginas web tanto como la realizacion y la sostenibilidad de esta </p>
             <a class="linkd" href="servicios_web">Mas informacion</a>
        </div>
        <div class="recomposicion">
        <img class="col1"src="{{voyager::image(setting('site.icon'))}}">
             <h1>Mantenimiento</h1>
