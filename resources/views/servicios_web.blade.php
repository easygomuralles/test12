...
<header>
    <div class="menu">
        ...
        <ul class="lis">
            <li><a id="pag" href="index">Inicio</a></li>
...
<div class="im">
    <img class="imv"src="{{voyager::image(setting('site.por3'))}}">
    <img class="imv1"src="{{voyager::image(setting('site.icon2'))}}">
    <h1 class="tit1">Servicios Web</h1>
     <p class="principal">  En internet son más de 4,950 millones de usuarios, aprovecha esta ventana de infinitas posibilidades creando, mejorando y posicionando tu negocio, a través del desarrollo de plataformas web con altos estándares de calidad y que al mismo te ayuda a reducir tus costos operativos.</p>
     <p class="principal" >Desarrollamos y trabajamos plataformas web que se adecuen a los distintos ambientes empleados en la industria.</p>
     <p class="principal" >♦ Ordenadores</p>
     <p class="principal" >♦ Mobiles</p>
</div>
 ...
 <div class="otras">
    ...
    <div class="soluciones">
        <div class="desarrollo_web">
             <img class="col"src="{{voyager::image(setting('site.icon'))}}">
             <h1>Mantenimiento </h1>
             <p>Si sientes tu portatil lento o que ya no funciona como antes podria ser que necesite un mantenimiento urguente </p>
             <a class="linkd" href="mante">Mas informacion</a>
        </div>
